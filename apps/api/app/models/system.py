...
class ComponentDependency(BaseModel):
    ...
    source_component: Mapped["SystemComponent"] = relationship(
        "SystemComponent", foreign_keys=[source_component_id], back_populates="outgoing_dependencies"
    )
    target_component: Mapped["SystemComponent"] = relationship(
        "SystemComponent", foreign_keys=[target_component_id], back_populates="incoming_dependencies"
    )